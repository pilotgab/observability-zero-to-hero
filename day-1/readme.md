...
## 🤔 Why Monitoring?
- I use monitoring to keep an eye on my systems and confirm that they are working properly.
...
## 🤔 Why Observability?
- I use observability to understand why my systems are behaving the way they are.
- It’s like having a detailed map and tools to explore and diagnose issues.

- I use observability to:
    - Diagnose Issues:
    - Understand Behavior:
    - Improve Systems:
...
| Example        | If a server's CPU usage goes above 90%, monitoring will alert me | If a website is slow, observability helps me trace the request through different services to find the bottleneck |
